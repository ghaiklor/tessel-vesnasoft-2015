...
util.inherits(Ambient, BaseModule);
 ...
 * @returns {Promise}
 */
Ambient.prototype.getLightBuffer = function () {
  var defer = Q.defer();
 ...
 * @returns {Promise}
 */
Ambient.prototype.getLightLevel = function () {
  var defer = Q.defer();
 ...
 * @returns {Promise}
 */
Ambient.prototype.getSoundBuffer = function () {
  var defer = Q.defer();
 ...
 * @returns {Promise}
 */
Ambient.prototype.getSoundLevel = function () {
  var defer = Q.defer();
 ...
 * @param {Function} cb
 */
Ambient.prototype.onLightTrigger = function (lightTriggerLevel, timeInterval, cb) {
 ...
 * @param {Function} cb
 */
Ambient.prototype.onSoundTrigger = function (soundTriggerLevel, timeInterval, cb) {
  var module = this.getNativeModule();
